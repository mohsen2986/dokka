...
class PackageListCreator(val context: DokkaContext) : PageTransformer {
    ...
    private fun packageList(pageNode: RootPageNode) =
        RendererSpecificRootPage("${pageNode.name}/package-list", emptyList(), RenderingStrategy.Write(PackageListService(context).formatPackageList(pageNode, "html", "html")))
}
